...
CREATE DATABASE IF NOT EXISTS `net_safe`;
USE `net_safe`;
...
CREATE TABLE `host_status_monitor`  (
  ...
  `host_id` varchar(64) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '主机ID',
...
-- Merged from standard_data.sql
INSERT INTO host_status_monitor (host_id, cpu_usage, memory_usage, network_conn, disk_usage, disk_info, file_status, monitor_time, create_time) VALUES 
('192.168.1.100', 15.5, 45.2, 12, 60.5, '300GB/500GB', '{"status":"normal"}', NOW(), NOW()),
('192.168.1.101', 85.2, 90.1, 150, 85.0, '425GB/500GB', '{"status":"warning"}', NOW(), NOW()),
('192.168.1.102', 5.0, 20.0, 5, 10.0, '50GB/500GB', '{"status":"normal"}', NOW(), NOW());
...
CREATE TABLE `network_threat_collection_api`  (
  `id` int NOT NULL AUTO_INCREMENT,
  `api_key` varchar(128) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT 'API密钥',
  `api_secret` varchar(128) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT 'API秘钥',
  `sync_status` tinyint NOT NULL DEFAULT 0 COMMENT '同步状态：0-未同步、1-同步中、2-成功、3-失败',
  `error_code` varchar(32) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT '' COMMENT '错误码',
  `create_time` datetime NULL DEFAULT CURRENT_TIMESTAMP,
...
CREATE TABLE `network_threat_collection_host`  (
  `id` int NOT NULL AUTO_INCREMENT,
  `host_ip` varchar(128) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '主机IP',
  `collect_freq` int NOT NULL COMMENT '采集频率（分钟）',
  `collect_status` tinyint NOT NULL DEFAULT 0 COMMENT '采集状态：0-未启动、1-运行中、2-暂停、3-异常',
  `error_msg` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT '' COMMENT '错误信息',
  `create_time` datetime NULL DEFAULT CURRENT_TIMESTAMP,
  `update_time` datetime NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 11 CHARACTER SET = utf8 COLLATE = utf8_general_ci ROW_FORMAT = DYNAMIC;
...
-- Merged from standard_data.sql (adapted collect_freq to int, removing 's')
INSERT INTO network_threat_collection_host (host_ip, collect_freq, collect_status, create_time, update_time) VALUES 
('192.168.1.100', 10, 1, NOW(), NOW()),
('192.168.1.101', 30, 1, NOW(), NOW()),
('192.168.1.102', 60, 0, NOW(), NOW());
...
CREATE TABLE `network_threat_upload`  (
  `id` int NOT NULL AUTO_INCREMENT,
  `report_file` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '报告文件路径',
...
CREATE TABLE `org_info`  (
  ...
  `org_name` varchar(128) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '组织名称',
...
-- Merged from standard_data.sql
INSERT INTO org_info (org_id, org_name, max_member_count, admin_permission) VALUES 
('ORG-HEAD', 'Headquarters', 100, 1),
('ORG-IT', 'IT Department', 50, 1),
('ORG-FIN', 'Finance Department', 30, 0),
('ORG-HR', 'Human Resources', 20, 0),
('ORG-DEV', 'Development Team', 80, 1);
...
CREATE TABLE `potential_threat_alert`  (
  `id` int NOT NULL AUTO_INCREMENT,
  `threat_id` varchar(64) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '威胁ID',
  `threat_level` tinyint NOT NULL COMMENT '威胁等级：1-低、2-中、3-高、4-严重',
  `impact_scope` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '影响范围',
  `occur_time` datetime NOT NULL COMMENT '发生时间',
  `create_time` datetime NULL DEFAULT CURRENT_TIMESTAMP,
  `source_ip` varchar(64) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '攻击源IP',
  `target_ip` varchar(64) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '受害目标IP',
  `status` varchar(20) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT 'Pending' COMMENT '处置状态: Pending, Blocked, Resolved',
  `handle_time` datetime NULL DEFAULT NULL COMMENT '处置时间',
  `handle_user` varchar(64) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '处置人',
  `chain_status` tinyint NULL DEFAULT 0 COMMENT '存证状态: 0-无, 1-已上链',
  `tx_hash` varchar(128) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '交易哈希',
...
-- ----------------------------
INSERT INTO `potential_threat_alert` VALUES (1, 'threat_20251215_001', 4, '192.168.1.105:44321 -> 192.168.1.1:80 | SQL Injection', '2025-12-15 09:15:22', '2025-12-15 09:15:22', NULL, NULL, 'Pending', NULL, NULL, 0, NULL, NULL);
INSERT INTO `potential_threat_alert` VALUES (2, 'threat_20251215_002', 3, '203.0.113.45:51200 -> 192.168.10.5:443 | XSS Attack', '2025-12-15 09:45:10', '2025-12-15 09:45:10', NULL, NULL, 'Pending', NULL, NULL, 0, NULL, NULL);
INSERT INTO `potential_threat_alert` VALUES (3, 'threat_20251215_003', 2, '10.0.5.20:12345 -> 10.0.5.100:22 | SSH Brute Force', '2025-12-15 10:05:33', '2025-12-15 10:05:33', NULL, NULL, 'Blocked', NULL, NULL, 0, NULL, NULL);
INSERT INTO `potential_threat_alert` VALUES (4, 'threat_20251215_004', 4, '112.14.55.66:60001 -> 192.168.1.88:3389 | RDP Exploit', '2025-12-15 10:30:45', '2025-12-15 10:30:45', NULL, NULL, 'Pending', NULL, NULL, 0, NULL, NULL);
INSERT INTO `potential_threat_alert` VALUES (5, 'threat_20251215_005', 1, '192.168.1.200:34567 -> 192.168.1.1:80 | Port Scan', '2025-12-15 11:12:00', '2025-12-15 11:12:00', NULL, NULL, 'Resolved', NULL, NULL, 0, NULL, NULL);
INSERT INTO `potential_threat_alert` VALUES (6, 'threat_20251215_006', 3, '172.16.0.50:4444 -> 172.16.0.10:8080 | Command Injection', '2025-12-15 11:45:18', '2025-12-15 11:45:18', NULL, NULL, 'Pending', NULL, NULL, 0, NULL, NULL);
INSERT INTO `potential_threat_alert` VALUES (7, 'threat_20251215_007', 2, '192.168.100.15:5566 -> 192.168.100.1:53 | DNS Tunneling', '2025-12-15 12:20:55', '2025-12-15 12:20:55', NULL, NULL, 'Pending', NULL, NULL, 0, NULL, NULL);
INSERT INTO `potential_threat_alert` VALUES (8, 'threat_20251215_008', 4, '45.33.22.11:80 -> 192.168.1.10:80 | DDoS Attack (SYN Flood)', '2025-12-15 13:10:22', '2025-12-15 13:10:22', NULL, NULL, 'Pending', NULL, NULL, 0, NULL, NULL);
INSERT INTO `potential_threat_alert` VALUES (9, 'threat_20251215_009', 2, '10.10.10.5:49152 -> 10.10.10.1:445 | SMB Ghost', '2025-12-15 13:45:40', '2025-12-15 13:45:40', NULL, NULL, 'Blocked', NULL, NULL, 0, NULL, NULL);
INSERT INTO `potential_threat_alert` VALUES (10, 'threat_20251215_010', 3, '192.168.3.45:3333 -> 192.168.3.1:21 | FTP Bounce Attack', '2025-12-15 14:15:15', '2025-12-15 14:15:15', NULL, NULL, 'Pending', NULL, NULL, 0, NULL, NULL);
INSERT INTO `potential_threat_alert` VALUES (11, 'threat_20251215_011', 1, '192.168.1.110:56789 -> 192.168.1.1:161 | SNMP Walk', '2025-12-15 14:50:30', '2025-12-15 14:50:30', NULL, NULL, 'Resolved', NULL, NULL, 0, NULL, NULL);
INSERT INTO `potential_threat_alert` VALUES (12, 'threat_20251215_012', 4, '185.20.1.1:443 -> 192.168.1.20:80 | Malware C&C Communication', '2025-12-15 15:22:10', '2025-12-15 15:22:10', NULL, NULL, 'Pending', NULL, NULL, 0, NULL, NULL);
INSERT INTO `potential_threat_alert` VALUES (13, 'threat_20251215_013', 2, '172.20.10.2:5000 -> 172.20.10.1:80 | Directory Traversal', '2025-12-15 15:55:45', '2025-12-15 15:55:45', NULL, NULL, 'Pending', NULL, NULL, 0, NULL, NULL);
INSERT INTO `potential_threat_alert` VALUES (14, 'threat_20251215_014', 3, '10.0.0.55:11223 -> 10.0.0.1:6379 | Redis Unauthorized Access', '2025-12-15 16:30:20', '2025-12-15 16:30:20', NULL, NULL, 'Pending', NULL, NULL, 0, NULL, NULL);
INSERT INTO `potential_threat_alert` VALUES (15, 'threat_20251215_015', 1, '192.168.50.15:43210 -> 192.168.50.1:80 | Web Crawler', '2025-12-15 17:10:05', '2025-12-15 17:10:05', NULL, NULL, 'Pending', NULL, NULL, 0, NULL, NULL);
...
-- Merged from standard_data.sql (adapted to schema)
INSERT INTO potential_threat_alert (threat_id, threat_level, impact_scope, occur_time, create_time) VALUES 
('threat_std_001', 4, '192.168.1.200 -> 192.168.1.100 | SQL Injection', NOW(), NOW()),
('threat_std_002', 3, '10.0.0.5 -> 192.168.1.101 | Port Scan', NOW(), NOW()),
('threat_std_003', 5, 'External IP -> 192.168.1.102 | DDoS Attack', NOW(), NOW());
...
CREATE TABLE `process_monitor`  (
  ...
  `process_name` varchar(128) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '进程名称',
  `process_status` tinyint NOT NULL COMMENT '进程状态：0-运行、1-暂停、2-异常、3-终止',
  `abnormal_reason` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT '' COMMENT '异常原因',
  `create_time` datetime NULL DEFAULT CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`) USING BTREE,
...
CREATE TABLE `report_share`  (
  ...
  `shared_org_id` varchar(64) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '共享组织ID',
...
CREATE TABLE `threat_report_config`  (
  `id` int NOT NULL AUTO_INCREMENT,
  `report_type` varchar(64) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '报告类型',
  `start_time` datetime NOT NULL COMMENT '开始时间',
  `end_time` datetime NOT NULL COMMENT '结束时间',
  `report_status` tinyint NOT NULL DEFAULT 0 COMMENT '报告状态：0-未生成、1-生成中、2-已生成、3-生成失败',
  `report_url` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT '' COMMENT '报告下载路径',
  `create_time` datetime NULL DEFAULT CURRENT_TIMESTAMP,
  `update_time` datetime NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`) USING BTREE,
...
CREATE TABLE `threat_source_tracing`  (
  `id` int NOT NULL AUTO_INCREMENT,
  `threat_source` varchar(128) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '威胁来源',
  `malicious_ip` varchar(64) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '恶意IP',
  `attack_cmd` text CHARACTER SET utf8 COLLATE utf8_general_ci NULL COMMENT '去掉默认值，因TEXT类型不支持',
  `malware_origin` varchar(128) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT '' COMMENT '恶意软件来源',
  `attack_path` text CHARACTER SET utf8 COLLATE utf8_general_ci NULL COMMENT '去掉默认值，因TEXT类型不支持',
  `flow_chart` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `create_time` datetime NULL DEFAULT CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`) USING BTREE,
...
CREATE TABLE `threat_traffic_stat`  (
  `id` int NOT NULL AUTO_INCREMENT,
  `attack_type` varchar(64) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '攻击类型',
  `source_ip` varchar(64) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '源IP',
  `target_ip` varchar(64) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '目标IP',
...
-- Records of sys_user
-- ----------------------------
INSERT INTO `sys_user` VALUES (1, 'admin', '123456', 1, 1, '2025-11-27 22:42:05', '2025-11-27 22:42:05');
-- Merged from standard_data.sql (adapted to schema)
